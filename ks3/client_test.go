...
func (s *Ks3ClientSuite) deleteBucket(client *Client, bucketName string, c *C) {
...
func (s *Ks3ClientSuite) TestGetBucketLocation(c *C) {
	...
	c.Assert(strings.HasPrefix(loc, "ks3-"), Equals, true)
...
func (s *Ks3ClientSuite) TestSetBucketLifecycleOverLap(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
...
func (s *Ks3ClientSuite) TestSetBucketLifecycleAboutVersionObject(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
...
// TestSetBucketLifecycleAboutVersionObject
func (s *Ks3ClientSuite) TestSetBucketLifecycleAboutVersionObjectError(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
...
// TestSetBucketLifecycleAboutVersionObject
func (s *Ks3ClientSuite) TestSetBucketLifecycleAboutVersionObjectNew(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
...
func (s *Ks3ClientSuite) TestSetBucketReferer(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
	var referers = []string{"http://www.ksyun.com", "https://www.ksyun.com"}
	...
	c.Assert(res.RefererList[0], Equals, "http://www.ksyun.com")
	c.Assert(res.RefererList[1], Equals, "https://www.ksyun.com")
...
func (s *Ks3ClientSuite) TestBucketRefererNegative(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
	var referers = []string{""}
...
func (s *Ks3ClientSuite) TestSetBucketWebsite(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
...
func (s *Ks3ClientSuite) TestDeleteBucketWebsite(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
	var indexWebsite = "myindex.html"
	var errorWebsite = "myerror.html"
...
func (s *Ks3ClientSuite) TestSetBucketWebsiteNegative(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
	var indexWebsite = "myindex.html"
	var errorWebsite = "myerror.html"
...
func (s *Ks3ClientSuite) TestSetBucketWebsiteDetail(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
	var indexWebsite = "myindex.html"
	var errorWebsite = "myerror.html"
...
func (s *Ks3ClientSuite) TestSetBucketWebsiteXml(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
// TestGetBucketInfo
func (s *Ks3ClientSuite) TestGetBucketInfo(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
	...
	c.Assert(strings.HasPrefix(res.BucketInfo.Location, "ks3-"), Equals, true)
...
func (s *Ks3ClientSuite) TestGetBucketInfoNegative(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
...
// TestCname
func (s *Ks3ClientSuite) _TestCname(c *C) {
...
// TestCnameNegative
func (s *Ks3ClientSuite) _TestCnameNegative(c *C) {
	var bucketNameTest = "<my-bucket-cname>"
...
// _TestHTTPS
func (s *Ks3ClientSuite) _TestHTTPS(c *C) {
...
// TestProxy
func (s *Ks3ClientSuite) ProxyTestFunc(c *C, authVersion AuthVersionType, extraHeaders []string) {
	bucketNameTest := bucketNamePrefix + RandLowStr(6)
	objectName := "体育/奥运/首金"
...
func (s *Ks3ClientSuite) TestProxy(c *C) {
...
func (s *Ks3ClientSuite) TestHttpsEndpointProxy(c *C) {
	bucketNameTest := bucketNamePrefix + RandLowStr(6)
...
func (s *Ks3ClientSuite) HttpLogSignUrlTestFunc(c *C, authVersion AuthVersionType, extraHeaders []string) {
...
func (s *Ks3ClientSuite) TestHttpLogSignUrl(c *C) {
...
func (s *Ks3ClientSuite) TestBucketEncyptionError(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestBucketEncryptionPutAndGetAndDelete(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestBucketEncryptionWithSm4(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestBucketEncryptionWithKmsSm4(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestBucketEncyptionPutObjectSuccess(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestBucketEncyptionPutObjectError(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestBucketTaggingOperation(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestListBucketsTagging(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestGetBucketStat(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestGetBucketVersioning(c *C) {
...
func (s *Ks3ClientSuite) TestSetBucketRequestPayment(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestSetBucketRequestPaymentNegative(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestBucketQos(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestSetBucketInventory(c *C) {
	...
	invEncryption.SseKs3 = nil
	invConfig.KS3BucketDestination.Encryption = &invEncryption
	err = client.SetBucketInventory(bucketName, invConfig)
	c.Assert(err, IsNil)

	// case 3: use SseKs3 encryption
	invConfig.Id = "report3"
	invEncryption.SseKms = nil
	invEncryption.SseKs3 = &invSseKs3
	invConfig.KS3BucketDestination.Encryption = &invEncryption
	err = client.SetBucketInventory(bucketName, invConfig)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestBucketInventory(c *C) {
	...
	invConfig.KS3BucketDestination.XMLName.Local = "KS3BucketDestination"
	...
	invConfig2.KS3BucketDestination.XMLName.Local = "KS3BucketDestination"
...
func (s *Ks3ClientSuite) TestBucketAsyncTask(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestClientOptionHeader(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestInitiateBucketWormSuccess(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestInitiateBucketWormFailure(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
// TestAbortBucketWorm
func (s *Ks3ClientSuite) TestAbortBucketWorm(c *C) {
	var bucketNameTest = bucketNamePrefix + RandLowStr(6)
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestCompleteBucketWorm(c *C) {
...
func (s *Ks3ClientSuite) TestExtendBucketWorm(c *C) {
	var bucketNameTest = bucketNamePrefix + "-worm-" + RandLowStr(6)
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3ClientSuite) TestBucketTransferAcc(c *C) {
...
func (s *Ks3ClientSuite) TestBucketReplicationPutAndGet(c *C) {
	var sourceBucketNameTest = bucketNamePrefix + "-replication-" + RandLowStr(6)

	sourceRegion := "hangzhou"
	sourceEndpoint := "ks3-cn-" + sourceRegion + ".ksyuncs.com"
	...
	destinationEndpoint := "ks3-cn-" + destinationRegion + ".ksyuncs.com"
	...
	<ReplicationConfiguration>
	  <Rule>
		...
		<Destination>
		  ...
		  <Location>ks3-cn-` + destinationRegion + `</Location>
		</Destination>
	...
	c.Assert(result.Rules[0].Destination.Location, Equals, "ks3-cn-"+destinationRegion)
...
func (s *Ks3ClientSuite) TestBucketReplicationDeleteSuccess(c *C) {
	var sourceBucketNameTest = bucketNamePrefix + "-replication-" + RandLowStr(6)
...
// TestBucketReplicationDelete
func (s *Ks3ClientSuite) TestBucketReplicationDeleteWithEmptyRuleID(c *C) {
	var sourceBucketNameTest = bucketNamePrefix + "-replication-" + RandLowStr(6)
...
func (s *Ks3ClientSuite) TestBucketReplicationGetLocation(c *C) {
	var sourceBucketNameTest = bucketNamePrefix + "-replication-" + RandLowStr(6)
...
func (s *Ks3ClientSuite) TestBucketReplicationGetProgressWithRuleID(c *C) {
	var sourceBucketNameTest = bucketNamePrefix + "-replication-" + RandLowStr(6)
	...
	firstDestinationEndpoint := "ks3-cn-" + firstDestinationRegion + ".ksyuncs.com"
	...
	secondDestinationEndpoint := "ks3-cn-" + secondDestinationRegion + ".ksyuncs.com"
	...
	<ReplicationConfiguration>
	  <Rule>
		...
		<Destination>
		  ...
		  <Location>ks3-cn-` + firstDestinationRegion + `</Location>
		</Destination>
		<HistoricalObjectReplication>enabled</HistoricalObjectReplication>
	  </Rule>
	</ReplicationConfiguration>`
	...
	<ReplicationConfiguration>
	  <Rule>
		...
		<Destination>
		  ...
		  <Location>ks3-cn-` + secondDestinationRegion + `</Location>
		</Destination>
		<HistoricalObjectReplication>enabled</HistoricalObjectReplication>
	  </Rule>
	</ReplicationConfiguration>`
	...
	var index int
	for i := 0; i <= 1; i++ {
		if result.Rules[i].Destination.Location == "ks3-cn-"+secondDestinationRegion {
			index = i
			break
		}
	}
	...
	c.Assert(progressResult.Rules[0].Destination.Location, Equals, "ks3-cn-"+secondDestinationRegion)
...
func (s *Ks3ClientSuite) TestBucketReplicationGetProgressWithEmptyRuleID(c *C) {
	var sourceBucketNameTest = bucketNamePrefix + "-replication-" + RandLowStr(6)
	...
	var firstIndex int
	for i := 0; i <= 1; i++ {
		if result.Rules[i].Destination.Location == ("ks3-cn-" + firstDestinationRegion) {
			firstIndex = i
			break
		}
	}
	...
	c.Assert(result.Rules[firstIndex].Destination.Location, Equals, "ks3-cn-"+firstDestinationRegion)
	...
	c.Assert(result.Rules[secondIndex].Destination.Location, Equals, "ks3-cn-"+secondDestinationRegion)
...
func (s *Ks3ClientSuite) TestGetBucketCName(c *C) {
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func emptyBodytargetHandler(w http.ResponseWriter, r *http.Request) {
	w.Header().Set(HTTPHeaderKs3RequestID, "123456")
	w.WriteHeader(309)
	fmt.Fprintf(w, "")
}
...
func serviceErrorBodytargetHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set(HTTPHeaderKs3RequestID, "ABCDEF")
	w.WriteHeader(510)
...
func (s *Ks3ClientSuite) TestExtendHttpResponseStatusCode(c *C) {
	// get port
	rand.Seed(time.Now().Unix())
	port := 10000 + rand.Intn(10000)
