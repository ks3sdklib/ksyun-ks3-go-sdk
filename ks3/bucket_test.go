...
func (s *Ks3BucketSuite) TestVersioningBucketVerison(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningPutAndGetObject(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningHeadObject(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningDeleteLatestVersionObject(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningDeleteOldVersionObject(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningDeleteDefaultVersionObject(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
	...
	c.Assert(respHeader.Get("x-ks3-delete-marker"), Equals, "true")
...
func (s *Ks3BucketSuite) TestVersioningListObjectVersions(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningBatchDeleteVersionObjects(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningBatchDeleteDefaultVersionObjects(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningBatchDeleteNormalObjects(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningSymlink(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	c.Assert(getResult.Get("x-ks3-symlink-target"), Equals, objectName1)

	// GetSymlink for object2
	getResult, err = bucket.GetSymlink(linkName, VersionId(linkVersionIdV2))
	c.Assert(err, IsNil)
	c.Assert(getResult.Get("x-ks3-symlink-target"), Equals, objectName2)
...
func (s *Ks3BucketSuite) TestVersioningObjectAcl(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningAppendObject(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningCopyObject(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningCompleteMultipartUpload(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningUploadPartCopy(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningRestoreObject(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningObjectTagging(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestVersioningIsObjectExist(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestSupportUserSetParam(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
...
func (s *Ks3BucketSuite) TestPutObjectWithKmsSm4(c *C) {
	// create a bucket with default proprety
	client, err := New(endpoint, accessID, accessKey)
	c.Assert(err, IsNil)
	...
	c.Assert(err, IsNil)
	c.Assert(headers.Get(HTTPHeaderKs3ServerSideEncryption), Equals, "KMS")
	c.Assert(headers.Get(HTTPHeaderKs3ServerSideDataEncryption), Equals, "SM4")
	c.Assert(err, IsNil)
	ForceDeleteBucket(client, bucketName, c)
}
