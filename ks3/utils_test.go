...
type Ks3UtilsSuite struct{}

var _ = Suite(&Ks3UtilsSuite{})

func (s *Ks3UtilsSuite) TestUtilsTime(c *C) {
...
func (s *Ks3UtilsSuite) TestUtilsSplitFile(c *C) {
...
func (s *Ks3UtilsSuite) TestUtilsFileExt(c *C) {
...
func (s *Ks3UtilsSuite) TestGetPartEnd(c *C) {
...
func (s *Ks3UtilsSuite) TestParseRange(c *C) {
...
func (s *Ks3UtilsSuite) TestAdjustRange(c *C) {
	// Nil
...
func (s *Ks3UtilsSuite) TestUtilCheckBucketName(c *C) {
...
func (s *Ks3UtilsSuite) TestGetRangeString(c *C) {
...
func (s *Ks3UtilsSuite) TestLimitReadCloser(c *C) {
