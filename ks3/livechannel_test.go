...
type Ks3BucketLiveChannelSuite struct {
	client *Client
	bucket *Bucket
}

var _ = Suite(&Ks3BucketLiveChannelSuite{})
...
func (s *Ks3BucketLiveChannelSuite) SetUpTest(c *C) {

}

// TearDownTest	Run after each test or benchmark runs.
func (s *Ks3BucketLiveChannelSuite) TearDownTest(c *C) {

}

// TestCreateLiveChannel
func (s *Ks3BucketLiveChannelSuite) TestCreateLiveChannel(c *C) {
...
func (s *Ks3BucketLiveChannelSuite) TestDeleteLiveChannel(c *C) {
...
func (s *Ks3BucketLiveChannelSuite) TestGetLiveChannelInfo(c *C) {
...
func (s *Ks3BucketLiveChannelSuite) TestPutLiveChannelStatus(c *C) {
...
func (s *Ks3BucketLiveChannelSuite) TestGetLiveChannelHistory(c *C) {
...
func (s *Ks3BucketLiveChannelSuite) TestGetLiveChannelStat(c *C) {
...
// TestPostVodPlaylist
func (s *Ks3BucketLiveChannelSuite) TestPostVodPlaylist(c *C) {
...
// TestPostVodPlaylist
func (s *Ks3BucketLiveChannelSuite) TestGetVodPlaylist(c *C) {
...
// TestListLiveChannel
func (s *Ks3BucketLiveChannelSuite) TestListLiveChannel(c *C) {
...
// TestSignRtmpURL
func (s *Ks3BucketLiveChannelSuite) TestSignRtmpURL(c *C) {
