...
//            https://help.ksyun.com/document_detail/ks3/api-reference/multipart-upload/InitiateMultipartUpload.html
//
...
// partSize    the part size
// partNumber    the part number, ranges from 1 to 10,000. If it exceeds the range KS3 returns InvalidArgument error.
...
//            https://help.ksyun.com/document_detail/ks3/api-reference/multipart-upload/UploadPartCopy.html
//
// UploadPart    the return value consists of PartNumber and ETag.
// error    it's nil if the operation succeeds, otherwise it's an error object.
//
